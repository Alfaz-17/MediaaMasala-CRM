...
\restrict qHLahQbLcWhmbSE1N9oNXD777BnRcejIA9BykgtQVq3nMSvqYpAk2jdwbXm5tuJ
...
ALTER TABLE IF EXISTS ONLY public.tasks DROP CONSTRAINT IF EXISTS "tasks_relatedToLeadId_fkey";
ALTER TABLE IF EXISTS ONLY public.tasks DROP CONSTRAINT IF EXISTS "tasks_projectId_fkey";
ALTER TABLE IF EXISTS ONLY public.tasks DROP CONSTRAINT IF EXISTS "tasks_productId_fkey";
ALTER TABLE IF EXISTS ONLY public.tasks DROP CONSTRAINT IF EXISTS "tasks_creatorId_fkey";
ALTER TABLE IF EXISTS ONLY public.tasks DROP CONSTRAINT IF EXISTS "tasks_assigneeId_fkey";
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS "roles_departmentId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS "projects_relationshipManagerId_fkey";
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS "projects_projectManagerId_fkey";
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS "projects_leadId_fkey";
ALTER TABLE IF EXISTS ONLY public.products DROP CONSTRAINT IF EXISTS "products_productManagerId_fkey";
ALTER TABLE IF EXISTS ONLY public.leave_requests DROP CONSTRAINT IF EXISTS "leave_requests_employeeId_fkey";
ALTER TABLE IF EXISTS ONLY public.leave_requests DROP CONSTRAINT IF EXISTS "leave_requests_approvedById_fkey";
ALTER TABLE IF EXISTS ONLY public.leads DROP CONSTRAINT IF EXISTS "leads_ownerId_fkey";
ALTER TABLE IF EXISTS ONLY public.leads DROP CONSTRAINT IF EXISTS "leads_departmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.lead_notes DROP CONSTRAINT IF EXISTS "lead_notes_leadId_fkey";
ALTER TABLE IF EXISTS ONLY public.lead_notes DROP CONSTRAINT IF EXISTS "lead_notes_authorId_fkey";
ALTER TABLE IF EXISTS ONLY public.lead_assignment_logs DROP CONSTRAINT IF EXISTS "lead_assignment_logs_performedById_fkey";
ALTER TABLE IF EXISTS ONLY public.lead_assignment_logs DROP CONSTRAINT IF EXISTS "lead_assignment_logs_leadId_fkey";
ALTER TABLE IF EXISTS ONLY public.lead_assignment_logs DROP CONSTRAINT IF EXISTS "lead_assignment_logs_assignedToId_fkey";
ALTER TABLE IF EXISTS ONLY public.follow_up_logs DROP CONSTRAINT IF EXISTS "follow_up_logs_leadId_fkey";
ALTER TABLE IF EXISTS ONLY public.follow_up_logs DROP CONSTRAINT IF EXISTS "follow_up_logs_employeeId_fkey";
ALTER TABLE IF EXISTS ONLY public.eod_reports DROP CONSTRAINT IF EXISTS "eod_reports_employeeId_fkey";
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS "employees_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS "employees_roleId_fkey";
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS "employees_managerId_fkey";
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS "employees_departmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS "attendance_employeeId_fkey";
ALTER TABLE IF EXISTS ONLY public.activity_logs DROP CONSTRAINT IF EXISTS "activity_logs_employeeId_fkey";
DROP INDEX IF EXISTS public.users_email_key;
DROP INDEX IF EXISTS public.tasks_status_idx;
DROP INDEX IF EXISTS public."tasks_relatedToLeadId_idx";
DROP INDEX IF EXISTS public."tasks_projectId_status_idx";
DROP INDEX IF EXISTS public."tasks_projectId_idx";
DROP INDEX IF EXISTS public."tasks_productId_idx";
DROP INDEX IF EXISTS public.tasks_priority_idx;
DROP INDEX IF EXISTS public."tasks_dueDate_idx";
DROP INDEX IF EXISTS public."tasks_creatorId_idx";
DROP INDEX IF EXISTS public."tasks_assigneeId_status_idx";
...
DROP INDEX IF EXISTS public."projects_relationshipManagerId_idx";
DROP INDEX IF EXISTS public."projects_projectManagerId_idx";
DROP INDEX IF EXISTS public."projects_leadId_key";
DROP INDEX IF EXISTS public."products_productManagerId_idx";
DROP INDEX IF EXISTS public.products_name_key;
DROP INDEX IF EXISTS public."permissions_module_action_scopeType_key";
DROP INDEX IF EXISTS public.leave_requests_status_idx;
DROP INDEX IF EXISTS public."leave_requests_startDate_idx";
DROP INDEX IF EXISTS public."leave_requests_endDate_idx";
DROP INDEX IF EXISTS public."leave_requests_employeeId_idx";
DROP INDEX IF EXISTS public.leads_status_idx;
DROP INDEX IF EXISTS public.leads_source_idx;
DROP INDEX IF EXISTS public."leads_ownerId_status_idx";
DROP INDEX IF EXISTS public."leads_ownerId_idx";
DROP INDEX IF EXISTS public."leads_departmentId_idx";
DROP INDEX IF EXISTS public."leads_createdAt_idx";
DROP INDEX IF EXISTS public."lead_notes_leadId_idx";
DROP INDEX IF EXISTS public."lead_notes_authorId_idx";
DROP INDEX IF EXISTS public."lead_assignment_logs_leadId_idx";
DROP INDEX IF EXISTS public."lead_assignment_logs_assignedToId_idx";
DROP INDEX IF EXISTS public."follow_up_logs_scheduledDate_idx";
DROP INDEX IF EXISTS public."follow_up_logs_leadId_idx";
DROP INDEX IF EXISTS public."follow_up_logs_employeeId_idx";
DROP INDEX IF EXISTS public."follow_up_logs_completedDate_idx";
DROP INDEX IF EXISTS public."eod_reports_employeeId_idx";
DROP INDEX IF EXISTS public.eod_reports_date_idx;
DROP INDEX IF EXISTS public."employees_userId_key";
DROP INDEX IF EXISTS public."employees_roleId_idx";
DROP INDEX IF EXISTS public."employees_managerId_idx";
DROP INDEX IF EXISTS public."employees_isActive_idx";
DROP INDEX IF EXISTS public."employees_empId_key";
DROP INDEX IF EXISTS public.employees_email_key;
DROP INDEX IF EXISTS public."employees_departmentId_idx";
...
DROP INDEX IF EXISTS public."attendance_employeeId_date_key";
DROP INDEX IF EXISTS public.attendance_date_idx;
DROP INDEX IF EXISTS public.activity_logs_module_idx;
DROP INDEX IF EXISTS public."activity_logs_module_createdAt_idx";
DROP INDEX IF EXISTS public."activity_logs_entityId_idx";
DROP INDEX IF EXISTS public."activity_logs_employeeId_idx";
...
ALTER TABLE IF EXISTS ONLY public.lead_notes DROP CONSTRAINT IF EXISTS lead_notes_pkey;
ALTER TABLE IF EXISTS ONLY public.lead_assignment_logs DROP CONSTRAINT IF EXISTS lead_assignment_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.follow_up_logs DROP CONSTRAINT IF EXISTS follow_up_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.eod_reports DROP CONSTRAINT IF EXISTS eod_reports_pkey;
...
ALTER TABLE IF EXISTS public.lead_notes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.lead_assignment_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.follow_up_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.eod_reports ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.lead_notes_id_seq;
DROP TABLE IF EXISTS public.lead_notes;
DROP SEQUENCE IF EXISTS public.lead_assignment_logs_id_seq;
DROP TABLE IF EXISTS public.lead_assignment_logs;
DROP SEQUENCE IF EXISTS public.follow_up_logs_id_seq;
DROP TABLE IF EXISTS public.follow_up_logs;
DROP SEQUENCE IF EXISTS public.eod_reports_id_seq;
...
1850	287	2026-03-11 00:00:00	2026-03-11 04:23:27.366	\N	Present	\N	\N	2026-03-11 04:23:27.366	2026-03-11 04:23:27.366
1851	281	2026-03-11 00:00:00	2026-03-11 04:58:04.333	\N	Present	\N	\N	2026-03-11 04:58:04.333	2026-03-11 04:58:04.333
1852	297	2026-03-11 00:00:00	2026-03-11 05:41:12.092	\N	Present	\N	\N	2026-03-11 05:41:12.092	2026-03-11 05:41:12.092
1853	291	2026-03-11 00:00:00	2026-03-11 06:29:11.89	\N	Present	\N	\N	2026-03-11 06:29:11.89	2026-03-11 06:29:11.89
1854	284	2026-03-11 00:00:00	2026-03-11 06:35:13.05	\N	Present	\N	\N	2026-03-11 06:35:13.05	2026-03-11 06:35:13.05
1855	280	2026-03-11 00:00:00	2026-03-11 08:56:06.181	\N	Present	\N	\N	2026-03-11 08:56:06.181	2026-03-11 08:56:06.181
\.
...
9538	137	1348	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9539	137	1352	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9540	137	1356	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9541	137	1360	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9542	137	1364	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9543	137	1368	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9544	137	1372	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9545	137	1376	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9546	137	1380	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9547	137	1384	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9548	137	1388	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9549	137	1404	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9550	137	1408	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9551	137	1400	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9552	137	1396	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9553	137	1392	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9554	137	1412	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9555	137	1416	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9556	137	1420	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9557	137	1424	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9558	137	1428	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9559	137	1432	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9560	137	1436	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9561	137	1440	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9562	137	1444	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9563	137	1448	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9564	137	1452	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9565	137	1456	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9566	137	1460	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9567	137	1464	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9568	137	1468	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9569	137	1472	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9570	137	1476	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9571	137	1480	2026-03-08 12:10:11.154	2026-03-08 12:10:11.154
9572	138	1348	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9573	138	1352	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9574	138	1355	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9575	138	1364	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9576	138	1367	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9577	138	1371	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9578	138	1375	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9579	138	1383	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9580	138	1419	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
9581	138	1421	2026-03-08 12:10:11.575	2026-03-08 12:10:11.575
2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9856	158	1370	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9857	158	1382	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9858	158	1388	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9859	158	1404	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9860	158	1420	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9861	158	1421	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9862	158	1428	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9863	158	1432	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9864	158	1433	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9865	158	1440	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9866	158	1444	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9867	158	1445	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9868	158	1456	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9869	158	1460	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9870	158	1464	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9871	158	1468	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9872	158	1472	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9873	158	1476	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
9874	158	1480	2026-03-08 12:10:16.907	2026-03-08 12:10:16.907
\.
...
137	Admin	ADMIN	Full system control	t	2026-03-06 09:00:13.054	2026-03-08 12:10:11.323	41	16
138	Head Of Department	HOD		t	2026-03-06 10:12:46.262	2026-03-08 12:10:11.742	42	20
139	Business Development Executive	BDE		t	2026-03-06 10:14:19.821	2026-03-08 12:10:12.075	42	16
140	Business Development Manager	BDM		t	2026-03-06 10:14:53.249	2026-03-08 12:10:12.408	42	16
141	Business Manager	BM		t	2026-03-06 10:15:08.806	2026-03-08 12:10:12.741	42	16
142	Chief Executive Officer	CEO		t	2026-03-06 10:17:30.421	2026-03-08 12:10:13.074	41	17
143	Relationship Manager	RM		t	2026-03-06 10:19:55.898	2026-03-08 12:10:13.407	42	18
145	Operations Manager 	OM		t	2026-03-06 12:42:54.196	2026-03-08 12:10:13.741	46	15
147	Head Of Creative 	HOD_CreaTIVE		t	2026-03-06 12:51:24.703	2026-03-08 12:10:14.074	44	13
148	UIUX Designer	UIUX		t	2026-03-06 19:20:25.248	2026-03-08 12:10:14.408	44	12
149	Head Of Product 	HOD_PRODUCT		t	2026-03-06 20:43:20.16	2026-03-08 12:10:14.741	43	10
150	Product Manager	PM		t	2026-03-06 20:43:37.858	2026-03-08 12:10:15.075	43	10
151	Product Architect 	PROD_ARC		t	2026-03-06 20:44:26.3	2026-03-08 12:10:15.408	43	10
152	Graphic Designer 	GRA_DES		t	2026-03-06 21:25:13.492	2026-03-08 12:10:15.741	44	6
153	Product Developer  Intern	PROD_DEV_INTRN		t	2026-03-08 11:43:28.794	2026-03-08 12:10:16.075	43	5
154	UIUX Intern 	UIUX_INTRN		t	2026-03-08 11:45:43.814	2026-03-08 12:10:16.408	44	4
157	Graphic Designer Intern	GRA_DESi_INTRN		t	2026-03-08 11:46:47.119	2026-03-08 12:10:16.741	44	4
158	HR Manager	HRM		t	2026-03-08 11:50:41.627	2026-03-08 12:10:17.075	41	4
159	Head Of Project	HEAD_PROJ		t	2026-03-08 11:54:20.771	2026-03-08 12:10:17.241	47	5
161	Project Manager 	PROJ_M		t	2026-03-08 11:56:09.47	2026-03-08 12:10:17.408	47	4
\.
...
SELECT pg_catalog.setval('public.activity_logs_id_seq', 259, true);
...
SELECT pg_catalog.setval('public.attendance_id_seq', 1855, true);
...
SELECT pg_catalog.setval('public.role_permissions_id_seq', 9874, true);
...
\unrestrict qHLahQbLcWhmbSE1N9oNXD777BnRcejIA9BykgtQVq3nMSvqYpAk2jdwbXm5tuJ
